...
function start()
    if not initialized then
        ...
        set_alert_tile()
        if fallout.global_var(146) ~= 0 and fallout.external_var("radio_room_attacked") ~= 0 then
...
function set_alert_tile()
    ...
    if tile_num == 23328 then
        alert_tile = 25870
    elseif tile_num == 22325 then
        alert_tile = 25468
    elseif tile_num == 22329 then
        alert_tile = 25070
    end
end
