...
function PaladinBRandom()
    ...
    v1 = fallout.message_str(326, 101)
    if v0 == 2 then
        v1 = fallout.message_str(326, 102)
    else
        if v0 == 3 then
            v1 = fallout.message_str(326, 103)
        else
            if v0 == 4 then
                v1 = fallout.message_str(326, 104)
            else
                if v0 == 5 then
                    v1 = fallout.message_str(326, 105)
                else
                    if v0 == 6 then
                        if fallout.get_critter_stat(fallout.dude_obj(), 34) == 0 then
                            v1 = fallout.message_str(326, 106)
                        else
                            v1 = fallout.message_str(326, 107)
                        end
                    else
                        v0 = 1
                    end
