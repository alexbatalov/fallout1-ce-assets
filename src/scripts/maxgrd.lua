...
function talk_p_proc()
    ...
    local msg
    if rnd == 1 then
        msg = fallout.message_str(618, 101)
    elseif rnd == 2 then
        msg = fallout.message_str(618, 102)
    elseif rnd == 3 then
        msg = fallout.message_str(618, 103)
    elseif rnd == 4 then
        msg = fallout.message_str(618, 104)
    elseif rnd == 5 then
        msg = fallout.message_str(618, 105)
    elseif rnd == 6 then
        msg = fallout.message_str(618, 106)
    elseif rnd == 7 then
        msg = fallout.message_str(618, 107)
    elseif rnd == 8 then
        msg = fallout.message_str(618, 108)
    elseif rnd == 9 then
        msg = fallout.message_str(618, 110) ..
