...
function use_p_proc()
    fallout.set_map_var(18, fallout.map_var(18) + 1)
...
function use_skill_on_p_proc()
    ...
    if fallout.local_var(0) == 0 then
        if fallout.action_being_used() == 9 then
            fallout.script_overrides()
            v0 = fallout.roll_vs_skill(fallout.dude_obj(), 9, -80)
            if fallout.is_success(v0) then
                fallout.set_local_var(0, 1)
                fallout.set_map_var(18, 4)
...
function use_obj_on_p_proc()
    ...
    v1 = fallout.roll_vs_skill(fallout.dude_obj(), 9, -60)
    fallout.set_map_var(18, fallout.map_var(18) + 1)
...
function damage_p_proc()
    fallout.set_map_var(18, fallout.map_var(18) + 2)
end
