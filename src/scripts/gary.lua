...
function talk_p_proc()
    if fallout.global_var(35) < 1 then
        if fallout.global_var(306) == 0 then
            ...
            fallout.display_msg(fallout.message_str(65, 104))
        end
    end
end
...
function look_at_p_proc()
    ...
    fallout.display_msg(fallout.message_str(65, 101))
end

function mutant01()
    fallout.float_msg(fallout.self_obj(), fallout.message_str(65, 102), 3)
    combat()
end

function mutant02()
    fallout.float_msg(fallout.self_obj(), fallout.message_str(65, 103), 3)
end
