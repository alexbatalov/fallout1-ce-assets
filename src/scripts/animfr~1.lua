...
function aradesh01()
    ...
    fallout.giq_option(5, 33, 109, aradesh07, 50)
...
function aradesh02()
    ...
    fallout.giq_option(4, 33, 113, aradesh01_2, 50)
    fallout.giq_option(5, 33, 114, aradesh02_4, 50)
...
function aradesh03()
    ...
    fallout.giq_option(4, 33, 118, aradesh01_2, 50)
    fallout.giq_option(5, 33, 119, aradesh07, 50)
    fallout.giq_option(4, 33, 120, aradesh07, 50)
end
...
function aradesh05()
    ...
    fallout.giq_option(5, 33, 123, aradesh06, 50)
    fallout.giq_option(4, 33, 124, aradesh04, 50)
    fallout.giq_option(4, 33, 125, aradesh07, 50)
end

function aradesh06()
    fallout.gsay_message(33, 126, 50)
    aradeshx1()
end

function aradesh07()
    fallout.gsay_message(33, 127, 50)
    aradeshx2()
end

function aradesh08()
    fallout.gsay_reply(33, 128)
    fallout.giq_option(4, 33, 129, aradesh08a, 50)
    fallout.giq_option(5, 33, 130, aradesh08b, 50)
end
...
function aradesh11()
    ...
    fallout.giq_option(4, 33, 138, aradesh11b, 50)
end
...
function aradesh13()
    fallout.gsay_message(33, 143, 50)
    aradeshend()
end

function aradesh14()
    fallout.gsay_reply(33, 144)
    fallout.giq_option(5, 33, 145, aradesh06, 50)
    fallout.giq_option(4, 33, 146, aradesh04, 50)
    fallout.giq_option(4, 33, 147, aradesh07, 50)
end
...
function aradesh17()
    ...
    fallout.giq_option(5, 33, 155, aradesh17_3, 50)
...
function aradesh25()
    ...
    fallout.giq_option(6, 33, 187, aradesh19, 50)
end
...
function aradesh28()
    ...
    fallout.giq_option(0, 33, 197, aradesh28a, 50)
end

function aradesh28a()
    fallout.gsay_reply(33, 198)
    fallout.giq_option(5, 33, 199, aradesh29, 49)
    fallout.giq_option(9, 33, 200, aradesh28b, 50)
    fallout.giq_option(5, 33, 201, aradesh28c, 50)
end
...
function aradesh30()
    ...
    fallout.giq_option(5, 33, 204, aradesh30b, 50)
...
function aradesh37()
    ...
    if fallout.global_var(27 == 1) then
