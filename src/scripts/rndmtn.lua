        ...
        if (fallout.global_var(32) ~= 1) and fallout.metarule(14, 0) then
            ...
            while Encounter_Num == 0 do
                ...
                if fallout.global_var(65) == 2 then
                    ...
                    if fallout.global_var(65) == 3 then
                        South_table()
                    else
                        Vault_table()
                    end
...
function North5()
    ...
    while Tot_Critter_A do
        ...
        if v0 then
            ...
            while v0 do
                Item = fallout.create_object_sid(71, fallout.tile_num_in_direction(fallout.tile_num(Critter), fallout.random(0, 5), fallout.random(2, 4)), 0, -1)
                v0 = v0 - 1
            end
            v0 = 0
        end
...
function North6()
    ...
    while Tot_Critter_A do
        ...
        if (v0 == 5) or (v0 == 0) then
            Item = fallout.create_object_sid(v1, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 8) - 4, v0, fallout.random(1, 6)), 0, -1)
            continue
        end
        Item = fallout.create_object_sid(v1, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 8) - 4, v0, fallout.random(1, 9)), 0, -1)
        Tot_Critter_A = Tot_Critter_A - 1
    end
    Tot_Critter_A = 10
    while Tot_Critter_A do
        ...
        v0 = fallout.random(0, 5)
        if (v0 == 5) or (v0 == 0) then
            Item = fallout.create_object_sid(33554861 + v1, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 4) - 2, v0, fallout.random(1, 6)), 0, -1)
            continue
        end
        Item = fallout.create_object_sid(33554861 + v1, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 4) - 2, v0, fallout.random(1, 9)), 0, -1)
        Tot_Critter_A = Tot_Critter_A - 1
    end
    Tot_Critter_A = 3
    while Tot_Critter_A do
        v0 = fallout.random(0, 5)
        if (v0 == 5) or (v0 == 0) then
            Item = fallout.create_object_sid(33554860, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 4) - 2, v0, fallout.random(3, 6)), 0, -1)
            continue
        end
        Item = fallout.create_object_sid(33554860, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 4) - 2, v0, fallout.random(3, 9)), 0, -1)
        Tot_Critter_A = Tot_Critter_A - 1
    end
    v0 = fallout.roll_vs_skill(fallout.dude_obj(), 17, 20 * fallout.has_trait(0, fallout.dude_obj(), 16))
    if 1 == 1 then
        ...
        if 1 == 1 then
            ...
            Critter_direction = 2
            Place_critter()
            Item = fallout.item_caps_adjust(Critter, fallout.random(10, 60) * (fallout.has_trait(0, fallout.dude_obj(), 20) + 1))
...
function South5()
    ...
    while Tot_Critter_A do
        ...
        Item = fallout.create_object_sid(Critter_type, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 8) - 4, fallout.random(0, 5), fallout.random(0, 11)), 0, -1)
        Tot_Critter_A = Tot_Critter_A - 1
    end
    Item = fallout.create_object_sid(33554514, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 4) - 2, fallout.random(0, 5), fallout.random(1, 8)), 0, -1)
    Item = fallout.create_object_sid(33554515, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 8) - 4, fallout.random(0, 5), fallout.random(2, 7)), 0, -1)
    Item = fallout.create_object_sid(7, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 4) - 2, fallout.random(0, 5), fallout.random(3, 7)), 0, -1)
    Item = fallout.create_object_sid(4, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 4) - 2, fallout.random(0, 5), fallout.random(2, 9)), 0, -1)
    Item = fallout.create_object_sid(4, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 8) - 4, fallout.random(0, 5), fallout.random(2, 7)), 0, -1)
    Outer_ring = 9
    Inner_ring = 3
    Critter_script = -1
    ...
    if fallout.get_critter_stat(fallout.dude_obj(), 6) >= 4 then
        if fallout.random(0, 1) then
            Item = fallout.create_object_sid(29, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 8) - 4, fallout.random(0, 5), fallout.random(3, 6)), 0, -1)
            if fallout.has_trait(0, fallout.dude_obj(), 40) then
                Item = fallout.create_object_sid(29, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 8) - 4, fallout.random(0, 5), fallout.random(3, 6)), 0, -1)
            end
        end
        if fallout.random(0, 1) then
            Item = fallout.create_object_sid(30, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 8) - 4, fallout.random(0, 5), fallout.random(3, 6)), 0, -1)
            if fallout.has_trait(0, fallout.dude_obj(), 40) then
                Item = fallout.create_object_sid(30, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 8) - 4, fallout.random(0, 5), fallout.random(3, 6)), 0, -1)
            end
        end
    ...
    if fallout.get_critter_stat(fallout.dude_obj(), 6) >= 9 then
        if fallout.random(0, 1) then
            Item = fallout.create_object_sid(8, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 8) - 4, fallout.random(0, 5), fallout.random(3, 6)), 0, -1)
        else
            if fallout.random(0, 1) then
                Item = fallout.create_object_sid(10, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 8) - 4, fallout.random(0, 5), fallout.random(3, 6)), 0, -1)
            else
                Item = fallout.create_object_sid(94, fallout.tile_num_in_direction(Dude_tile + fallout.random(0, 8) - 4, fallout.random(0, 5), fallout.random(3, 6)), 0, -1)
            end
        end
    end
    Tot_Critter_A = 0
...
function Vault5()
    local v0 = 0
    v0 = fallout.do_check(fallout.dude_obj(), 5, 0)
    if not(fallout.is_success(v0)) then
        if fallout.is_critical(v0) then
