...
function Raider5()
    ...
    if fallout.random(0, 1) ~= 0 then
        Item = fallout.item_caps_adjust(Critter,
            fallout.random(5, 10) * (fallout.has_trait(0, fallout.dude_obj(), 20) + 1))
    end
end
...
function Necrop4()
    ...
    Item = fallout.create_object_sid(33554747,
        ...
        0, -1)
    if fallout.random(0, 3) == 3 then
        tile_num = fallout.tile_num_in_direction(fallout.tile_num(fallout.dude_obj()), fallout.random(0, 5),
            fallout.random(0, 5))
        v2 = fallout.random(0, 4)
        if v2 == 0 then
            fallout.create_object_sid(29, tile_num, 0, -1)
        elseif v2 == 1 then
            fallout.create_object_sid(30, tile_num, 0, -1)
        elseif v2 == 2 then
            fallout.create_object_sid(34, tile_num, 0, -1)
        elseif v2 == 3 then
            fallout.create_object_sid(31, tile_num, 0, -1)
        elseif v2 == 4 then
            fallout.create_object_sid(111, tile_num, 0, -1)
        end
    end
    tile_num = fallout.tile_num_in_direction(fallout.tile_num(fallout.dude_obj()), fallout.random(0, 5),
        fallout.random(3, 5))
    fallout.create_object_sid(33554541, tile_num, 0, -1)
    tile_num = fallout.tile_num_in_direction(fallout.tile_num(fallout.dude_obj()), fallout.random(0, 5),
        fallout.random(3, 5))
    fallout.create_object_sid(33554437, tile_num, 0, -1)
    tile_num = fallout.tile_num_in_direction(fallout.tile_num(fallout.dude_obj()), fallout.random(0, 5),
        fallout.random(3, 5))
    fallout.create_object_sid(33554524, tile_num, 0, -1)
end
