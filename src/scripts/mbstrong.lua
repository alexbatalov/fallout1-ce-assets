...
fallout.create_external_var("local radio_computer")
fallout.create_external_var("local radio_room_attacked")
fallout.create_external_var("local removal_ptr")
fallout.create_external_var("local valid_target")
fallout.create_external_var("local FieldC1a_ptr")
fallout.create_external_var("local FieldC1b_ptr")
fallout.create_external_var("local FieldC2a_ptr")
fallout.create_external_var("local FieldC2b_ptr")
fallout.create_external_var("local Field1a_Ptr")
fallout.create_external_var("local Field2a_Ptr")
fallout.create_external_var("local Field3a_Ptr")
fallout.create_external_var("local Field4a_Ptr")
fallout.create_external_var("local Field5a_Ptr")
fallout.create_external_var("local Field6a_Ptr")
fallout.create_external_var("local Field1b_Ptr")
fallout.create_external_var("local Field2b_Ptr")
