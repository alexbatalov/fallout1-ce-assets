...
function start()
    if not initialized then
        initialized = true
        misc.set_team(fallout.self_obj(), 36)
...
function look_at_p_proc()
    ...
    fallout.display_msg(fallout.message_str(767, 100))
end
...
function caravan03()
    ...
    fallout.giq_option(0, 767, 115, caravan03d, 50)
...
function caravan03a()
    ...
    fallout.game_time_advance(fallout.game_ticks(60 * 60 * 24 * 3))
...
function caravan03c()
    ...
    fallout.set_global_var(199, 1)
    v0 = fallout.random(1, 4)
    fallout.game_time_advance(fallout.game_ticks(60 * 60 * 24 * 5))
    fallout.item_caps_adjust(fallout.dude_obj(), 600)
    if v0 < 3 then
        v0 = fallout.random(1, 4)
        if v0 == 1 then
