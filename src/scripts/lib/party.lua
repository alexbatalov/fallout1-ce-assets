...
local function add_party()
    local party_elevation = fallout.elevation(fallout.dude_obj())
    ...
    return party_elevation
end

local function update_party(party_elevation)
...
local exports = {}
exports.add_party = add_party
exports.update_party = update_party
exports.remove_party = remove_party
return exports
